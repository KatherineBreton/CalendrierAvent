...
<h3 class="titre3">1. Présentation du site</h3>
    ...
    <ul>
        <li>Propriétaire : FNAC</li>
        <li>Créateur : Katherine BRETON</li>
        <li>Responsable publication : Katherine BRETON – contact@fnac.com</li>
        <li>Le responsable publication est une personne physique ou une personne morale.</li>
        <li>Webmaster : Katherine BRETON – contact@fnac.com</li>
...
<h3 class="titre3">3. Description des services fournis</h3>
    ...
    Katherine BRETON s’efforce de fournir sur le site www.calendrieravent.fr des informations aussi précises que possible. Toutefois, il ne pourra être tenue responsable des omissions, des inexactitudes et des carences dans la mise à jour, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces informations.
...
<h3 class="titre3">5. Propriété intellectuelle et contrefaçons</h3>
    ...
    Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de : Katherine BRETON.
...
<h3 class="titre3">6. Limitations de responsabilité</h3>
    ...
    Katherine BRETON ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du site www.calendrieravent.fr.
...
<h3 class="titre3">7. Gestion des données personnelles</h3>
    ...
    A l'occasion de l'utilisation du site www.calendrieravent.fr, peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site www.calendrieravent.fr, le fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.

    En tout état de cause Katherine BRETON ne collecte des informations personnelles relatives à l'utilisateur que pour le besoin de certains services proposés par le site www.calendrieravent.fr. L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à l'utilisateur du site www.calendrieravent.fr l’obligation ou non de fournir ces informations.

    Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, tout utilisateur dispose d’un droit d’accès, de rectification et d’opposition aux données personnelles le concernant, en effectuant sa demande écrite et signée, accompagnée d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la réponse doit être envoyée.

    Aucune information personnelle de l'utilisateur du site www.calendrieravent.fr n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat de Katherine BRETON et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de l'utilisateur du site www.calendrieravent.fr.
...
<h3 class="titre3">8. Liens hypertextes et cookies</h3>
    ...
    La navigation sur le site www.calendrieravent.fr est susceptible de provoquer l’installation de cookie(s) sur l’ordinateur de l’utilisateur. Un cookie est un fichier de petite taille, qui ne permet pas l’identification de l’utilisateur, mais qui enregistre des informations relatives à la navigation d’un ordinateur sur un site. Les données ainsi obtenues visent à faciliter la navigation ultérieure sur le site, et ont également vocation à permettre diverses mesures de fréquentation.
